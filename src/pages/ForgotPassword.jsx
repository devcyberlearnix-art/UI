...
import { Mail, ArrowLeft, Send, Shield, AlertCircle } from "lucide-react";
...
function ForgotPassword() {
  ...
  const handleSendOtp = async () => {
    ...
    try {
      ...
      setSuccess(true);
      setTimeout(() => navigate("/reset-otp", { state: { email } }), 2000);
    } catch (err) {
  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-[#0a0f1c]">
      {/* Same background effects as Login */}
        ...
        <div className="w-full max-w-md p-6">
          <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl">
            <div className="text-center mb-8">
              ...
              <p className="text-gray-400 text-sm">We'll send you a secure OTP to reset your password</p>
            </div>
