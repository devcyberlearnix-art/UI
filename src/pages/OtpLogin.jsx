  ...
  return (
    <div className="min-h-screen flex relative overflow-hidden bg-[#0a0f1c]">
      ...
      <div className="relative z-10 flex w-full">
        {/* Left brand section (same as before) */}
          ...
          <div className="max-w-lg">
            <div className="mb-12">
              <div className="flex items-center gap-3 mb-4">
                ...
                <span className="text-2xl font-bold bg-gradient-to-r from-white to-blue-200 bg-clip-text text-transparent">LearnMaster</span>
              </div>
              <p className="text-gray-400 text-sm">Premium Learning Platform</p>
            </div>
            <h1 className="text-5xl font-bold text-white mb-6 leading-tight">
              OTP Login
              <span className="block bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">Fast & Secure</span>
            </h1>
            <p className="text-gray-400 text-lg mb-8 leading-relaxed">Get a one‑time password on your email for quick and secure access without remembering passwords.</p>
            ...
            <div className="bg-white/5 backdrop-blur-xl rounded-2xl border border-white/10 p-8 shadow-2xl">
              ...
              <div className="space-y-5">
                ...
                <div className="text-center">
                  <button onClick={() => navigate("/login")} className="text-sm text-gray-400 hover:text-blue-400 transition-colors flex items-center justify-center gap-1 mx-auto">
              ...
              <div className="mt-6 text-center">
                <div className="flex items-center justify-center gap-2 text-xs text-gray-500">
                  <Shield size={12} />
                  <span>Secure OTP • Valid for 5 minutes</span>
                </div>
              </div>
            </div>
          </div>
